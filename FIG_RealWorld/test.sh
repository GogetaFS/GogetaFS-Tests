...
FILE_SYSTEMS=( "f2fs" "HFDedup2" "smartdedup" "GogetaFS" "GogetaFS" )
TIMERS=( "fio_f2fs_trace.sh.sh" "fio_f2fs_trace.sh.sh" "fio_f2fs_trace.sh.sh" "fio_f2fs_trace.sh.sh" "fio_f2fs_trace.sh.sh" )
